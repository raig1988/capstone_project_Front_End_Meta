    ...
    return (
        <nav>
            <ul className="nav-fullWidth">
                ...
                <li><Link to="/about" aria-label='Site'>About</Link></li>
                <li><Link to="/menu" aria-label='Site '>Menu</Link></li>
                <li><Link to="/booking" aria-label='Site'>Reservations</Link></li>
                <li><Link to="/order" aria-label='site'>Order Online</Link></li>
                <li><Link to="/login" aria-label='site'>Login</Link></li>
            </ul>
